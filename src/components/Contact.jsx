  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_TEMPLATE_ID,
      {
        ...
        to_email: 'anandk212307@gmail.com',
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea rows={7} name="message" value={form.message} onChange={handleChange} placeholder="What do you want say?" className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"/>
          </label>
